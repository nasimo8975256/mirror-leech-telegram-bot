...
def stats(update, context):
    ...
    stats = f'<b>⏲️ আপটাইম:</b> {currentTime}\n\n'\
            ...
            f'<b>📀 ব্যবহৃত ডিস্কস্পেস:</b> {used} | <b>🔥 ফ্রী স্পেস:</b> {free}\n\n'\
            f'<b>📤 আপলোড:</b> {sent}\n'\
            f'<b>📥 ডাউনলোড:</b> {recv}\n\n'\
            ...
            f'<b>✍️ অনুবাদকঃ "আই এইচ নাছিম ©️"<b/> {mem_onx}\n'\
            f'<b>🙏 সম্পাদনায়ঃ "মোঃ ইকবাল হোসেন নাছিম"<b/>{mem_onxy}\n'
...
def start(update, context):
    ...
    buttons.buildbutton("Group", "https://t.me/ihnasimofficial")
...
'''
        ...
        sendMarkup('<b> You are not Authorized User, so you can not use this bot.To use bot Join Group or contact bot Owner </b>', context.bot, update, reply_markup)
